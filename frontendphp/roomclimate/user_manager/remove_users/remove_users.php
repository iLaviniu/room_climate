...
<html lang="en">
    <head>
        <base href="https://www.nestinbase.com/roomclimate/user_manager/remove_users/remove_users.php">
    ...
    <body>
        <div class="container-md">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-radius: 25px 8px 8px 25px; margin-top: 10px;">
                ...
                <a class="navbar-brand" href="https://www.nestinbase.com/roomclimate/dashboard/dashboard.php"><img src="../../res/icon.png" width="30px" height="30px" class="d-inline-block align-top" alt="">Dashboard</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav" style="margin-left: auto; margin-right: 0;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.nestinbase.com/roomclimate/user_manager/users/users_redirection.php" style="text-align: right;">Users</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.nestinbase.com/roomclimate/user_manager/new_comers/new_comers_redirection.php" style="text-align: right;">New Comers</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link active" href="https://www.nestinbase.com/roomclimate/user_manager/remove_users/remove_users_redirection.php" style="text-align: right;">Remove Users</a>
                        </li>
    ...
    <script language="javascript">
        ...
        function removeUsers(){
            ...
            if(jsonResult != "[]") {    
                ...
                xmlHttp.open("POST", "https://www.nestinbase.com/roomclimate/user_manager/remove_users/remove_selected_users_redirection.php", true);
