...
<html lang="en">
    <head>
        <base href="https://www.nestinbase.com/roomclimate/user_manager/users/users.php">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-radius: 25px 8px 8px 25px; margin-top: 10px;">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav" style="margin-left: auto; margin-right: 0;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="https://www.nestinbase.com/roomclimate/user_manager/users/users_redirection.php" style="text-align: right;">Users</a>
                        </li>
