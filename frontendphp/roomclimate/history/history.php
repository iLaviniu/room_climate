...
<html lang="en">
    <head>
        <base href="https://www.nestinbase.com/roomclimate/history/history.php">
    ...
    <body onload="onRefresh()">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav" style="margin-left: auto; margin-right: 0;">
                        ...
                        <li class="nav-item" <?php print $visibilityUserManagerMenu; ?>>
                            <a class="nav-link" href="https://www.nestinbase.com/roomclimate/user_manager/users/users_redirection.php" style="text-align: right;">User Manager</a>
                        </li>
                        
                             
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.nestinbase.com/roomclimate/history/history.php" style="text-align: right;">History</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.nestinbase.com/roomclimate/logout/logout_redirection.php" style="text-align: right;">Logout</a>
                        </li> 
        ...
        <script type="text/javascript">
            ...
            document.getElementById("datePicker").addEventListener("change", function() {
                ...
                xmlhttp.open("POST", "https://www.nestinbase.com/roomclimate/history/history_redirection.php", true);
