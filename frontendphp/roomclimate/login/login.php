...
<?php
    ...
    if((isset($_SESSION['userLoggedIn'])) && (true == $_SESSION['userLoggedIn'])) {
        header("Location: https://www.nestinbase.com/roomclimate/dashboard/dashboard.php");
    }
    ...
    <body>
        <div class="container-md">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-radius: 25px 8px 8px 25px; margin-top: 10px;">
                ...
                <a class="navbar-brand" href="https://www.nestinbase.com/roomclimate/dashboard/dashboard.php"><img src="../res/icon.png" width="30px" height="30px" class="d-inline-block align-top" alt="">Login</a>
