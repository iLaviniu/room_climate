<?php
    ...
    $sql_select_email = "select email from newcomersintent where email='".$account_user."'";
    ...
    if(($sql_select_email_result->num_rows == 0) and ($sql_select_newcomer_result->num_rows == 0) and ($sql_select_user_result->num_rows == 0)) {
        ...
        $sql_insert = "insert into newcomersintent (email, code_registration, creg_date_time) values ('".$account_user."', '".$random_number_register."', '".$nowPlus5Minutes."')";
