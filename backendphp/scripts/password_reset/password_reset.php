<?php
    ...
    if($sql_get_user_result->num_rows == 1) {
        ...
        if ($sql_update_result == true) {
            ...
            header("Location: https://www.nestinbase.com/roomclimate/new_password/new_password.php");
            
        } else {
            $_SESSION['userStatus'] = "error resetting password!";
            header("Location: https://www.nestinbase.com/roomclimate/password_reset/password_reset.php");
        }
