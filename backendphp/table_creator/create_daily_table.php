<?php
    include "/home/ilaviniu/backendphp/utilities/mysql_connection.php";
    ...
    if($isTable == true) {
        ...
        $sql_create_tomorrow_table = "CREATE TABLE `".$tomorrow."` (date_time DATETIME, periodicity_minutes VARCHAR(10), bmp_280_temp_c VARCHAR(20), bmp_280_temp_f VARCHAR(20), bmp_280_atmo_pa VARCHAR(20), bmp_280_atmo_hpa VARCHAR(20), dht_11_temp_c VARCHAR(20), dht_11_temp_f VARCHAR(20), dht_11_humidity VARCHAR(20), PRIMARY KEY (date_time))";
