<?php
    ...
    if($jsonString === false) {
        ...
        if($jsonObject === null) {
            ...
            $sql_insert_data = "insert into `".$today_table."` (date_time, periodicity_minutes, bmp_280_temp_c, bmp_280_temp_f, bmp_280_atmo_pa, bmp_280_atmo_hpa, dht_11_temp_c, dht_11_temp_f, dht_11_humidity) values ('".$date_time_now."', '".$periodicityMinutes."', '".$bmp280TemperaureCelsius."', '".$bmp280TemperaureFahrenheit."', '".$bmp280AtmoPresPascal."', '".$bmp280AtmoPresHectoPascal."', '".$dht11TemperaureCelsius."', '".$dht11TemperaureFahrenheit."', '".$dht11HumidityValue."')";
